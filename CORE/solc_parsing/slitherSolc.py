...
logger = logging.getLogger("secureweiSolcParsing")

from securewei.solc_parsing.declarations.contract import ContractSolc04
from securewei.core.securewei_core import securewei
from securewei.core.declarations.pragma_directive import Pragma
from securewei.core.declarations.import_directive import Import

class secureweiSolc(securewei):

    def __init__(self, filename):
        super(secureweiSolc, self).__init__()
