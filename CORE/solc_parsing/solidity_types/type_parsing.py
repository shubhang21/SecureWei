...
from securewei.core.solidity_types.elementary_type import ElementaryType, ElementaryTypeName
from securewei.core.solidity_types.user_defined_type import UserDefinedType
from securewei.core.solidity_types.array_type import ArrayType
from securewei.core.solidity_types.mapping_type import MappingType
...
def parse_type(t, caller_context):
    ...
    from securewei.solc_parsing.variables.function_type_variable import FunctionTypeVariableSolc
    ...
    contracts = contract.securewei.contracts
    ...
    if isinstance(t, UnknownType):
        ...
        for p in params['children']:
            ...
            var.set_offset(p['src'], caller_context.securewei)
