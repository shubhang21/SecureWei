...
from securewei.solc_parsing.cfg.node import NodeSolc
from securewei.core.cfg.node import NodeType
from securewei.core.cfg.node import link_nodes

from securewei.solc_parsing.variables.local_variable import LocalVariableSolc
from securewei.solc_parsing.variables.local_variable_init_from_tuple import LocalVariableInitFromTupleSolc
from securewei.solc_parsing.variables.variable_declaration import MultipleVariablesDeclaration
...
from securewei.visitors.expression.has_conditional import HasConditional

from securewei.utils.expression_manipulations import SplitTernaryExpression
...
class FunctionSolc(Function):
    ...
    def _parse_variable_definition(self, statement, node):
        ...
        try:
            ...
            local_var.set_offset(statement['src'], self.contract.securewei)
...
#
    def _parse_params(self, params):
        ...
        for param in params['children']:
            ...
            local_var.set_function(self)
            local_var.set_offset(param['src'], self.contract.securewei)
            local_var.analyze(self)
    ...
    def _parse_returns(self, returns):
        ...
        for ret in returns['children']:
            ...
            local_var.set_function(self)
            local_var.set_offset(ret['src'], self.contract.securewei)
            local_var.analyze(self)
