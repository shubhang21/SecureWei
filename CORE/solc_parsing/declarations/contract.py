...
from securewei.core.declarations.enum import Enum

from securewei.solc_parsing.declarations.structure import StructureSolc
from securewei.solc_parsing.declarations.event import EventSolc
from securewei.solc_parsing.declarations.modifier import ModifierSolc
from securewei.solc_parsing.declarations.function import FunctionSolc

from securewei.solc_parsing.variables.state_variable import StateVariableSolc

from securewei.solc_parsing.solidity_types.type_parsing import parse_type
...
class ContractSolc04(Contract):
    ...
    def __init__(self, secureweiSolc, data):
        assert secureweiSolc.solc_version.startswith('0.4')
        super(ContractSolc04, self).__init__()

        self.set_securewei(secureweiSolc)
        self._data = data
    ...
    def _analyze_enum(self, enum):
        ...
        new_enum.set_offset(enum['src'], self.securewei)
    ...
    def _parse_struct(self, struct):
        ...
        st.set_offset(struct['src'], self.securewei)
    ...
    def parse_state_variables(self):
        ...
        for varNotParsed in self._variablesNotParsed:
            ...
            var.set_offset(varNotParsed['src'], self.securewei)
    ...
    def _parse_modifier(self, modifier):
        ...
        modif.set_offset(modifier['src'], self.securewei)
    ...
    def _parse_function(self, function):
        ...
        func.set_offset(function['src'], self.securewei)
