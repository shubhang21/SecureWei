import logging
import re
from securewei.core.expressions.unary_operation import UnaryOperation, UnaryOperationType
from securewei.core.expressions.binary_operation import BinaryOperation, BinaryOperationType
from securewei.core.expressions.literal import Literal
from securewei.core.expressions.identifier import Identifier
from securewei.core.expressions.super_identifier import SuperIdentifier
...
from securewei.core.expressions.super_call_expression import SuperCallExpression
...
from securewei.solc_parsing.solidity_types.type_parsing import parse_type, UnknownType

from securewei.core.declarations.contract import Contract
from securewei.core.declarations.function import Function

from securewei.core.declarations.solidity_variables import SOLIDITY_VARIABLES, SOLIDITY_FUNCTIONS, SOLIDITY_VARIABLES_COMPOSED
from securewei.core.declarations.solidity_variables import SolidityVariable, SolidityFunction, SolidityVariableComposed, solidity_function_signature

from securewei.core.solidity_types.elementary_type import ElementaryType
from securewei.core.solidity_types.function_type import FunctionType
...
def find_variable(var_name, caller_context):
    ...
    all_enums = [c.enums_as_dict() for c in contract.securewei.contracts]
    ...
    contracts = contract.securewei.contracts_as_dict()
