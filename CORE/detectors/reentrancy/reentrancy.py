...
from securewei.core.declarations import Function, SolidityFunction
from securewei.core.expressions import UnaryOperation, UnaryOperationType
...
from securewei.slithir.operations import (HighLevelCall, LowLevelCall,
                                        LibraryCall,
                                        Send, Transfer)
...
class Reentrancy(AbstractDetector):
    ...
    def detect(self):
        ...
        for (contract, func, calls, send_eth), varsWritten in result.items():
