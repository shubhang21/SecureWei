...
from securewei.analyses.taint.calls import KEY
from securewei.analyses.taint.calls import run_taint as run_taint_calls
from securewei.analyses.taint.specific_variable import is_tainted
from securewei.analyses.taint.specific_variable import \
...
class ArbitrarySend(AbstractDetector):
    ...
    def detect(self):
        ...
        run_taint_calls(self.securewei)

        # Taint msg.value
        taint = SolidityVariableComposed('msg.value')
        run_taint_variable(self.securewei, taint)
