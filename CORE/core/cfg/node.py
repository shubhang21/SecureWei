...
from securewei.visitors.expression.expression_printer import ExpressionPrinter
from securewei.visitors.expression.read_var import ReadVar
from securewei.visitors.expression.write_var import WriteVar

from securewei.core.children.child_function import ChildFunction

from securewei.core.declarations.solidity_variables import SolidityFunction

from securewei.slithir.convert import convert_expression
...
class Node(SourceMapping, ChildFunction):
    ...
    @property
    def securewei(self):
        return self.function.securewei
