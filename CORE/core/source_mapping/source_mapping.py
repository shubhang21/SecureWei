import re
from securewei.core.context.context import Context
...
class SourceMapping(Context):
    ...
    @staticmethod
    def _convert_source_mapping(offset, securewei):
        '''
        ...
        '''
        sourceUnits = securewei.source_units
    ...
    def set_offset(self, offset, securewei):
        self._source_mapping = self._convert_source_mapping(offset, securewei)
