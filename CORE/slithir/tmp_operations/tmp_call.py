...
from securewei.core.declarations.solidity_variables import SolidityVariableComposed, SolidityFunction
from securewei.core.declarations.structure import Structure
from securewei.core.declarations.event import Event
