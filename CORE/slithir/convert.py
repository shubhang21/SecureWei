...
from securewei.core.declarations import (Contract, Enum, Event, SolidityFunction,
                                       Structure, SolidityVariableComposed, Function, SolidityVariable)
from securewei.core.expressions import Identifier, Literal
from securewei.core.solidity_types import ElementaryType, UserDefinedType, MappingType, ArrayType, FunctionType
from securewei.core.variables.variable import Variable
from securewei.slithir.operations import (Assignment, Binary, BinaryType, Call,
                                        ...
                                        Unpack)
from securewei.slithir.tmp_operations.argument import Argument, ArgumentType
...
from securewei.visitors.slithir.expression_to_slithir import ExpressionToSlithIR
...
def look_for_library(contract, ir, node, using_for, t):
    for destination in using_for[t]:
        lib_contract = contract.securewei.get_contract_from_name(str(destination))
        if lib_contract:
            ...
            if isinstance(ir, Assignment):
                ...
                if isinstance(t, UserDefinedType):
                    ...
                    if isinstance(t_type, Contract):
                        contract = node.securewei.get_contract_from_name(t_type.name)
                ...
                contract = node.securewei.get_contract_from_name(ir.contract_name)
